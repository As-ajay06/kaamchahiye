...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen pixel-bg flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="crosshair" style={{ top: '10%', left: '8%' }} />
      <div className="crosshair" style={{ bottom: '15%', right: '10%' }} />
      <div className="crosshair" style={{ top: '25%', right: '15%' }} />
      ...
      <div className="w-full max-w-md relative z-20">
        ...
        <div className="brutal-card p-10">
          ...
          <h1 className="font-display text-5xl tracking-tight mb-2">LOGIN</h1>
          <p className="text-xs uppercase tracking-widest text-gray-500 mb-8">
            Access your account<span className="animate-blink">_</span>
          </p>
